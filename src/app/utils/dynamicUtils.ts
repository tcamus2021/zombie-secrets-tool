...
export const getDynamicGame = (
	url: string,
	games: Array<Game>
): Game | undefined => games.find((game) => game.url === url);

export const getDynamicMap = (
	url: string,
	maps: Array<ZombieMap>
): ZombieMap | undefined => maps.find((map) => map.url === url);

export const getAllMaps = (games: Array<Game>): Array<ZombieMap> =>
	games.reduce((acc: Array<ZombieMap>, game: Game) => {
